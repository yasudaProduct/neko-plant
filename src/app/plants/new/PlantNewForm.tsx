...
export default function PlantNewForm({ defaultName = "" }: { defaultName?: string }) {
  ...
  const {
    ...
    // 検索で見つからなかった名前をそのまま初期値にする (/plants の0件導線から)
  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-8 pb-12">
      <div className="bg-white rounded-xl border border-border shadow-sm p-6">
        ...
        {/* 投稿フロー内の登録機能との使い分けを示し、迷子にしない */}
        <p className="mt-5 text-xs text-gray-500 text-center leading-normal">
          写真と一緒に登録したいときは、
          <Link href="/posts/new" className="text-green-700 hover:underline">
            写真を投稿する
          </Link>
          {" "}からでも植物を追加できます。
        </p>
